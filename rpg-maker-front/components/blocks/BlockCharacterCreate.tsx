        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='items-center justify-between sm:flex sm:gap-2'>
            ...
            <div className='flex gap-2'>
              <Select onValueChange={setSelectedMorality}>
              ...
              <Select onValueChange={setSelectedAttitude}>
                <SelectTrigger className="w-[180px]">
          ...
          <div className='grid gap-x-6 gap-y-2 lg:grid-cols-2'>
            <label className='flex gap-2 items-center justify-between'>
              <p>Age (years):</p>
              <input name="age" type='number' min={1} className='w-[100px] p-1 text-center text-sm border rounded' />
            </label>
            <label className='flex gap-2 items-center justify-between'>
              <p>Height (feets):</p>
              <input name="height" type='number' min={1} className='w-[100px] p-1 text-center text-sm border rounded' />
            </label>
            <label className='flex gap-2 items-center justify-between'>
              <p>Weight (pounds):</p>
              <input name="weight" type='number' min={1} className='w-[100px] p-1 text-center text-sm border rounded' />
            </label>
            <label className='flex gap-2 items-center justify-between'>
              <p>Hair color:</p>
              <input name="hair" type='text' className='w-[180px] p-1 text-center text-sm border rounded' />
            </label>
            <label className='flex gap-2 items-center justify-between'>
              <p>Skin color:</p>
              <input name="skin" type='text' className='w-[180px] p-1 text-center text-sm border rounded' />
            </label>
            <label className='flex gap-2 items-center justify-between'>
              <p>Eyes color:</p>
              <input name="eyes" type='text' className='w-[180px] p-1 text-center text-sm border rounded' />
            </label>
            <label className='flex flex-col gap-2 items-center justify-between lg:flex-row'>
              <p>Personality:</p>
              <textarea name="personality" rows={8} className='w-full p-1 text-center text-sm border rounded lg:w-[180px]' />
            </label>
            <label className='flex flex-col gap-2 items-center justify-between lg:flex-row'>
              <p>Ideals:</p>
              <textarea name="ideals" rows={8} className='w-full p-1 text-center text-sm border rounded lg:w-[180px]' />
            </label>
          </div>
