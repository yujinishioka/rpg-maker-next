export default function Home() {
  const data = [
    {id: 1, title: "Página: Personagens", descriptions: ["Exibir personagens criados, ou mensagem quando não existir", "Criar Personagem - criação de personagem"]},
  ...
  return <div className="container min-h-[calc(100vh-10.4rem)] my-6 lg:container lg:min-h-[calc(100vh-10rem)]">
